...
if (isset($_GET['selectedDate'])) {
    ...
    if ($date) {
        ...
        // Check if remaining capacity for the selected date is zero
        //$allZero = array_sum($remainingCapacity) == 0;
    } else {
...
// Set a session variable to communicate this information back to topLevel.php
//$_SESSION['allZero'] = $allZero;
...
<head>
    ...
    <title>Top Level | <?php echo date('d F Y', strtotime($selectedDateFormatted)); ?></title>
</head>
...
<body>
    ...
    <div class="content-wrapper">
        <div class="title">
            <h1>Top Level | <?php echo date('d F Y', strtotime($selectedDateFormatted)); ?></h1>
            <?php
