...
<head>
    ...
    <title>Lower Level | F2 Examination Hall</title>
</head>
...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        ...
        prevMonthBtn.addEventListener('click', function() {
            ...
            window.location.replace(`lowerLevel.php?year=${currentYear}&month=${currentMonth}`);
        });
        ...
        function handleViewButtonClick(day, year, month) {
            ...
            const url = `calendarDayLowerLevel.php?selectedDate=${formattedDate}`;
